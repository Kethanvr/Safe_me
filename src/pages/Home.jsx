...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100/60 via-white to-purple-100/60 flex flex-col font-poppins">
      {/* Modern Navbar */}
        ...
        <div className="container mx-auto px-4 py-3">
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-4 pb-4 space-y-2 border-t border-gray-200 pt-3">
              <a href="#dashboard" className="block py-2 px-3 rounded-md text-gray-700 hover:bg-primary/10 hover:text-primary font-medium text-sm" onClick={() => { setActiveSection('dashboard'); setIsMenuOpen(false); }}>Dashboard</a>
              <a href="#emergency" className="block py-2 px-3 rounded-md text-gray-700 hover:bg-primary/10 hover:text-primary font-medium text-sm" onClick={() => { setActiveSection('emergency'); setIsMenuOpen(false); }}>Emergency</a>
              <a href="#settings" className="block py-2 px-3 rounded-md text-gray-700 hover:bg-primary/10 hover:text-primary font-medium text-sm" onClick={() => { setActiveSection('settings'); setIsMenuOpen(false); }}>Settings</a>
              <a href="#help" className="block py-2 px-3 rounded-md text-gray-700 hover:bg-primary/10 hover:text-primary font-medium text-sm" onClick={() => { setActiveSection('help'); setIsMenuOpen(false); }}>Help Center</a>
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col pt-20 md:pt-24 pb-16 md:pb-20 px-4">
        <div className="container mx-auto max-w-6xl">
          {/* Welcome Section */}
          <section className="mb-8 md:mb-10" id="dashboard">
            ...
            {/* Status Card */}
            <Card className="backdrop-blur-lg bg-white/80 border border-primary/10 shadow-lg md:shadow-xl mb-6 md:mb-8 overflow-hidden">
              ...
              <CardHeader className="relative px-4 pt-4 md:px-6 md:pt-6">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg md:text-xl font-semibold text-gray-800">Safety Status</CardTitle>
              ...
              <CardContent className="relative px-4 pb-4 md:px-6 md:pb-6">
                {/* Profile Section */}
                <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-6 mb-6 md:mb-8 p-4 md:p-6 rounded-xl bg-gradient-to-r from-primary/5 to-indigo-400/5 border border-primary/10">
                  <div className="relative">
                    {user?.photoURL ? (
                      <img src={user.photoURL} alt="Profile" className="w-20 h-20 md:w-24 md:h-24 rounded-full border-4 border-white shadow-lg" />
                    ) : (
                      <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-r from-primary to-indigo-500 flex items-center justify-center border-4 border-white shadow-lg">
                  ...
                  <div className="text-center sm:text-left flex-1">
                    <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-1">{userProfile?.displayName || 'User'}</h2>
                    <p className="text-gray-500 text-xs md:text-sm break-all">{user?.email}</p>
                  ...
                  <div className="ml-auto mt-4 sm:mt-0 flex flex-col sm:flex-row gap-2">
                    <Button variant="outline" className="rounded-lg border-primary/20 text-primary hover:bg-primary/5 text-xs md:text-sm px-3 py-1.5 md:px-4 md:py-2">
                      Edit Profile
                    </Button>
                    <Button 
                      variant="destructive" 
                      onClick={handleLogout}
                      className="rounded-lg text-xs md:text-sm px-3 py-1.5 md:px-4 md:py-2 bg-red-500/10 text-red-600 border border-red-500/20 hover:bg-red-500/20"
                    >
                      Logout
                    </Button>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
                  <div className="bg-blue-50 rounded-xl p-4 md:p-5 border border-blue-100 flex flex-col items-center shadow-sm">
                    ...
                    <h3 className="text-gray-800 font-medium text-sm md:text-lg text-center">Location Check-ins</h3>
                    <p className="text-2xl md:text-3xl font-bold text-blue-600 mt-1 md:mt-2">42</p>
                    <p className="text-gray-500 text-xs mt-1">Last 30 days</p>
                  </div>
                  
                  <div className="bg-purple-50 rounded-xl p-4 md:p-5 border border-purple-100 flex flex-col items-center shadow-sm">
                    <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center mb-3">
                      <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                      </svg>
                    </div>
                    <h3 className="text-gray-800 font-medium text-sm md:text-lg text-center">Emergency Contacts</h3>
                    <p className="text-2xl md:text-3xl font-bold text-purple-600 mt-1 md:mt-2">3</p>
                    <p className="text-gray-500 text-xs mt-1">All verified</p>
                  </div>
                  
                  <div className="bg-green-50 rounded-xl p-4 md:p-5 border border-green-100 flex flex-col items-center shadow-sm">
                    <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center mb-3">
                      <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                      </svg>
                    </div>
                    <h3 className="text-gray-800 font-medium text-sm md:text-lg text-center">Safety Status</h3>
                    <p className="text-2xl md:text-3xl font-bold text-green-600 mt-1 md:mt-2">100%</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6" id="emergency">
                    ...
                    <div className="p-4 md:p-6 flex flex-col h-full">
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 md:ml-4">
                          <h3 className="text-base md:text-xl font-bold text-gray-800 group-hover:text-primary transition-colors duration-300">Emergency Contacts</h3>
                          <p className="text-gray-600 mt-1 mb-3 md:mb-4 text-xs md:text-sm">Add and manage trusted contacts who will be notified in case of emergency.</p>
                        </div>
                      </div>
                      
                      <div className="mt-auto">
                        <Button variant="default" className="w-full text-xs md:text-sm bg-gradient-to-r from-indigo-500 to-primary hover:from-indigo-600 hover:to-primary shadow-md group-hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="group bg-gradient-to-br from-white to-purple-50 rounded-xl overflow-hidden border border-primary/10 shadow-md hover:shadow-lg transition-all duration-300" id="settings">
                    <div className="p-4 md:p-6 flex flex-col h-full">
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 md:ml-4">
                          <h3 className="text-base md:text-xl font-bold text-gray-800 group-hover:text-primary transition-colors duration-300">Safety Settings</h3>
                          <p className="text-gray-600 mt-1 mb-3 md:mb-4 text-xs md:text-sm">Configure triggers, emergency responses, and safety features for quick access.</p>
                        </div>
                      </div>
                      
                      <div className="mt-auto">
                        <Button variant="default" className="w-full text-xs md:text-sm bg-gradient-to-r from-purple-600 to-primary hover:from-purple-700 hover:to-primary shadow-md group-hover:shadow-lg transition-all duration-300">
            ...
            {/* Help Center Card */}
            <Card className="backdrop-blur-lg bg-white/80 border border-primary/10 shadow-lg md:shadow-xl overflow-hidden" id="help">
              <div className="bg-gradient-to-r from-indigo-500 to-primary h-3"></div>
              <CardHeader className="relative pt-4 md:pt-6 px-4 md:px-6">
                <CardTitle className="text-lg md:text-xl font-semibold text-gray-800">Help Center & Resources</CardTitle>
              </CardHeader>
              
              <CardContent className="relative pb-4 md:pb-6 px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                  <div className="bg-white rounded-xl p-4 md:p-5 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300">
                    <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mb-4">
                      <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                      </svg>
                    </div>
                    <h3 className="text-gray-800 font-medium text-sm md:text-base">FAQs</h3>
                    <p className="text-gray-500 text-xs md:text-sm mt-1 md:mt-2">Find answers to frequently asked questions about using SaveMe.</p>
                  ...
                  <div className="bg-white rounded-xl p-4 md:p-5 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300">
                    ...
                    <h3 className="text-gray-800 font-medium text-sm md:text-base">Support</h3>
                    <p className="text-gray-500 text-xs md:text-sm mt-1 md:mt-2">Contact our support team for assistance with any issues.</p>
                  ...
                  <div className="bg-white rounded-xl p-4 md:p-5 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300">
                    ...
                    <h3 className="text-gray-800 font-medium text-sm md:text-base">User Guide</h3>
                    <p className="text-gray-500 text-xs md:text-sm mt-1 md:mt-2">Learn how to use all features of SaveMe effectively.</p>
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-gray-200 py-8 md:py-10 text-center">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center md:text-left mb-6 md:mb-0">
              <div>
          ...
          <div className="border-t border-gray-100 mt-6 md:mt-8 pt-6 md:pt-8">
      ...
      <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50">
        <Button className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-red-500 hover:bg-red-600 flex items-center justify-center shadow-lg hover:shadow-xl border-2 md:border-4 border-white transition-all duration-300">
